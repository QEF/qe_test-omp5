...
SUBROUTINE laxlib_dsqmsym_omp_x( n, a, lda, idesc )
   !
   ! Double precision SQuare Matrix SYMmetrization
   !
   USE laxlib_descriptor
...
!$omp end target teams distribute parallel do
   ...
   RETURN
END SUBROUTINE laxlib_dsqmsym_omp_x
#endif
! ---------------------------------------------------------------------------------
...
#elif defined (__OPENMP_GPU)
SUBROUTINE sqr_dmm_cannon_omp_x( transa, transb, n, alpha, a, lda, b, ldb, beta, c, ldc, idesc )
   !
...
END SUBROUTINE sqr_dmm_cannon_omp_x
#endif
!=----------------------------------------------------------------------------=!
...
#elif defined (__OPENMP_GPU)
SUBROUTINE sqr_tr_cannon_omp_x( n, a, lda, b, ldb, idesc )
   !
   !  Parallel square matrix transposition with Cannon's algorithm
   !
   !
...
END SUBROUTINE sqr_tr_cannon_omp_x
#endif
...
#elif defined (__OPENMP_GPU)
SUBROUTINE redist_row2col_omp_x( n, a, b, ldx, nx, idesc )
   !
   !  redistribute a, array whose second dimension is distributed over processor row,
...
END SUBROUTINE redist_row2col_omp_x
#endif
